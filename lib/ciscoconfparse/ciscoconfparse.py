...
from models_cisco import IOSACLLine     # added by mdube
from models_cisco import IOSIPACLLine   # added by mdube
from models_cisco import IOSIPACLChildLine   # added by mdube
...
def ConfigLineFactory(text="", comment_delimiter="!", syntax='ios'):
    ...
    if syntax=='ios':
        classes = [IOSIntfLine, IOSRouteLine, IOSAccessLine, 
            ...
            IOSHostnameLine, IOSIntfGlobal, IOSACLLine, IOSIPACLLine,
